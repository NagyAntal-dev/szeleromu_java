...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2022. Nov 16. 20:32
...
-- Adatbázis: `szeleromu`
--
CREATE DATABASE IF NOT EXISTS `szeleromu` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_hungarian_ci;
USE `szeleromu`;
...
CREATE TABLE `megye` (
  `id` int(11) NOT NULL,
  `nev` varchar(50) COLLATE utf8mb4_hungarian_ci NOT NULL,
  `regio` varchar(50) COLLATE utf8mb4_hungarian_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_hungarian_ci;
